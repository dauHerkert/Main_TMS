     ...
     document.getElementById("supplier_user").innerHTML = `Hello Supplier ${user.displayName}`
       ...
       if(window.location.pathname == "/admin"){
         ...
         update_user_form.addEventListener('submit', (e) =>{
           ...
           let docRef = doc(db,'users', update_user_form.id.value);
      ...
      async function getUserAdmin(){
         ...
         if (typeSnap.exists()) {
          ...
          return typeSnap.data().admin
           ...
           let userIsAdmin = await getUserAdmin();
 
           const account_button = document.getElementById('account_user_profile');
 
             if(userIsAdmin === "1"){
               account_button.setAttribute("href", "/admin");
               document.getElementById('welcome_user').innerHTML = `Hello Admin ${user.displayName}`;
             }else{
               account_button.setAttribute("href", "/sign-in");
             }
          ...
          if (typeSnap.exists()) {
           ...
           return typeSnap.data().type
            ...
            if (userType == "Supplier"){
              ...
              document.getElementById('account_type_info').innerHTML = `<b>Account type:</b> ${userType}`;
            }
